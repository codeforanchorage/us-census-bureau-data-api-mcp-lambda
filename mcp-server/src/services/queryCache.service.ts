// Ported from upstream PR #135
// (uscensusbureau/us-census-bureau-data-api-mcp). Caches Census API responses
// in the census_data_cache table, keyed by generate_cache_hash().
