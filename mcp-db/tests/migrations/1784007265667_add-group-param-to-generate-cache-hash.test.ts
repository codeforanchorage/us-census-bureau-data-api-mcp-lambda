...
} from '../../migrations/1784007265667_add-group-param-to-generate-cache-hash'

describe('Migration 1784007265667 - Add Group Param to Generate Cache Hash', () => {
  ...
  describe('up', () => {
    ...
    it('coalesces a NULL group so variable-only queries still hash', () => {
      expect(generateCacheHashNewVersion).toContain(`COALESCE("group", '')`)
    })
  })
